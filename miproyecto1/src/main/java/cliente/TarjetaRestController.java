 ...
 * @RestController
 * 
 * @RequestMapping("/webapi") public class TarjetaRestController {
 * 
 * @Autowired TarjetaRepository tarjetaRepository;
 * 
 * // ---------------------- crud: READ
 * ------------------------------------------- //
 * -----------------------------------------------------------------------------
 * 
 * @GetMapping("/allTarjeta") public Iterable<Carjeta> getAllTarjeta() {
 * 
 ...
 * ---------------------------------------------------------------------------
 * 
 * @GetMapping("/getTarjeta/{id}") public Tarjeta findById(@PathVariable int id)
 * {
 * 
 ...
 * ----------------------------------------------------------------------------
 * 
 * @DeleteMapping("/deleteTarjeta/{id}") public void deletTarjeta(@PathVariable
 * int id) {
 * 
 * Optional<Tarjeta> tarjetaFound = tarjetaRepository.findById(id);
 * 
 ...
 * ---------------------------------------------------------------------------
 * 
 * @PostMapping(path = "/addTarjeta", consumes = "application/json") public void
 * insertTarjeta(@RequestBody Tarjeta tarjeta) {
 * 
 * // System.out.println(book); tarjetaRepository.save(tarjeta); }
 * 
 * // ---------------------- crud: UPADATE (by Id)
 * ------------------------------- //
 * ----------------------------------------------------------------------------
 * 
 * @PutMapping("/updateTarjeta/{id}") public void upadateTarjeta(@RequestBody
 * Tarjeta tarjeta, @PathVariable int id) {
 * 
 * Optional<Tarjeta> tarjetaFound = tarjetaRepository.findById(id);
 * 
 * if (tarjetaFound.isPresent()) {
